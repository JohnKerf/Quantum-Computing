...
if __name__ == "__main__":
    ...
    H_json_path = None
    # Example:
    H_json_path = r"C:\Users\Johnk\Documents\PhD\Quantum Computing Code\Quantum-Computing\SUSY\Wess-Zumino\Analyses\Model Checks\GroundstatePauliContributions\dirichlet\linear\N3\linear_16.json"
    ...
    for cutoff in cutoffs:
        ...
        if n_kept > 1:
            ...
            for p in [0.05, 0.10, 0.15, 0.20, 0.25, 0.30, 0.35, 0.40, 0.50, 0.60, 0.70, 0.80]:
                v = int(round(p * n_kept))
                if 1 <= v < n_kept:
                    checkpoints.append(v)
