...
if __name__ == "__main__":
    ...
    H_json_path = None
    # Example:
    H_json_path = r"C:\Users\Johnk\Documents\PhD\Quantum Computing Code\Quantum-Computing\SUSY\Wess-Zumino\Analyses\Model Checks\GroundstatePauliContributions\dirichlet\linear\N3\linear_8.json"
    ...
    for cutoff in cutoffs:
        ...
        out = {
            "study": "one_term_ablation_after_truncation",
