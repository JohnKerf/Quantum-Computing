...
def run_vqe(i, bounds, max_iter, tol, abs_tol, strategy, popsize, H, num_qubits, shots, num_params, log_dir):
    ...
    param_objs = [Parameter(f"θ{i}") for i in range(num_qubits)]
...
if __name__ == "__main__":
    ...
    base_path = os.path.join(r"C:\Users\Johnk\Documents\PhD\Quantum Computing Code\Quantum-Computing\SUSY\SUSY QM\Qiskit\EstimatorV2\Files", potential)
