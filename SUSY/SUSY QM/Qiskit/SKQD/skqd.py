...
if __name__ == "__main__":
    ...
    for cutoff in [2,4,8,16,32,64,128]:
    #for cutoff in [16]:
        ...
        base_path = os.path.join(repo_path,r"SUSY\SUSY QM\Qiskit\SKQD\Files-Noise-Mit", backend_name, str(shots), potential)
        ...
        while not converged and k <= max_k:
            ...
            #top_states = [s[::-1] for s, c in sorted_states]
            ...
            me = np.linalg.eigvalsh(H_reduced.toarray()).min().real
            HRt = datetime.now() - t1
