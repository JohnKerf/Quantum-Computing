...
if __name__ == "__main__":
    ...
    for shots in shotslist:
        for cutoff in cutoffs:
            ...
            base_path = os.path.join(repo_path,r"SUSY\SUSY QM\Qiskit\NQCC Access\NoiseModel\Files", str(shots), potential)
            ...
            with Pool(processes=1) as pool:
                vqe_results = pool.starmap(
                    run_vqe,
                    [
                        (i, max_iter, initial_tr_radius, final_tr_radius, H, num_qubits, shots, num_params, log_path, log_enabled)
