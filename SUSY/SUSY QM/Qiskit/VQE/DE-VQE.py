...
def run_vqe(i, bounds, max_iter, tol, abs_tol, strategy, popsize, H, num_qubits, shots, num_params, log_dir):
    ...
    qc.append(CRYGate(param_objs[2]), [1, 2])
...
if __name__ == "__main__":
    ...
    base_path = os.path.join("/users/johnkerf/Quantum Computing/SUSY-QM/Qiskit/DifferentialEvolution/OptimizeHyperparams", str(popsize))
