...
def cost_function(params, H, num_qubits, shots):
    ...
    def circuit(params):
        ...
        expval = qml.expval(qml.Hermitian(H, wires=range(num_qubits)))  
        var = qml.var(qml.Hermitian(H, wires=range(num_qubits)))
    ...
    expval, var = circuit(params)

    return expval, var, device_time
...
def run_vqe(i, bounds, max_iter, tol, abs_tol, strategy, popsize, H, num_qubits, shots):
    ...
    def wrapped_cost_function(params):
        result, var, dt = cost_function(params, H, num_qubits, shots)
...
if __name__ == "__main__":
    ...
    for potential in potential_list:
        ...
        for shots in shot_list:
            ...
            base_path = os.path.join("/users/johnkerf/SUSY/VQE/QM/VarianceCheck/Files", potential, str(shots))
            ...
            for cut_off in cut_offs_list:
                ...
                variances = [res['variances'] for res in vqe_results]
