...
if __name__ == "__main__":
    ...
    for shots in shots_list:
        ...
        def eval_sample_energy(i):
            ...
            raw_samples = circuit(params)
            samples = np.array(raw_samples).T  
            energies = samples @ coeffs        
        ...
        plt.savefig(
            f"/users/johnkerf/Quantum Computing/SUSY-QM/EnergySampling/PauliSampling/Histograms/Histo_{shots}.png"
        )
    ...
    plt.savefig(
        "/users/johnkerf/Quantum Computing/SUSY-QM/EnergySampling/PauliSampling/Histograms/probs.png"
    )
