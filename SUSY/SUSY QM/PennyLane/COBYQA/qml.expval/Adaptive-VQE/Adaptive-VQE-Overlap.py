...
def run_adapt_vqe(i, max_iter, tol, H, num_qubits, shots, num_steps, phi, num_grad_checks, operator_pool, basis_state, min_eigenvalue, min_eigenvector, log_dir):
...
if __name__ == "__main__":
    ...
    for cutoff in cutoff_list:
        ...
        base_path = os.path.join(repo_path, r"SUSY\SUSY QM\PennyLane\COBYQA\qml.expval\Adaptive-VQE\StatevectorFiles-Overlap", potential)
        ...
        with Pool(processes=10) as pool:
            vqe_results = pool.starmap(
                run_adapt_vqe,
                [
                    (i, max_iter, tol, H, num_qubits, shots, num_steps, phi, num_grad_checks, operator_pool, basis_state, min_eigenvalue, min_eigenvector, log_path)
