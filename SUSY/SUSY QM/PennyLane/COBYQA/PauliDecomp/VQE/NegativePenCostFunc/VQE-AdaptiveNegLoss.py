...
def run_vqe(i, max_iter, tol, initial_tr_radius, final_tr_radius, H_decomp, num_qubits, shots, num_params, device, log_dir, log_enabled, eps, lam, p):
...
if __name__ == "__main__":
    ...
    for shots in shotslist:
        for cutoff in cutoffs:
            ...
            base_path = os.path.join("/users/johnkerf/fastscratch/Data/PennyLane/COBYQA/PauliDecomp/VQE/FilesNegPenAdaptive", str(shots), potential)
            ...
            with Pool(processes=100) as pool:
                vqe_results = pool.starmap(
                    run_vqe,
                    [
                        (i, max_iter, tol, initial_tr_radius, final_tr_radius, H_decomp, num_qubits, shots, num_params, device, log_path, log_enabled, eps, lam, p)
