...
def run_adapt_vqe(i, max_iter, tol, abs_tol, strategy, popsize, H, num_qubits, shots, num_steps, phi, num_grad_checks, operator_pool, basis_state):
...
if __name__ == "__main__":
    ...
    base_path = os.path.join(r"C:\Users\Johnk\Documents\PhD\Quantum Computing Code\Quantum-Computing\SUSY\SUSY QM\PennyLane\ADAPT-VQE\Files", potential)
    ...
    with Pool(processes=num_vqe_runs) as pool:
        vqe_results = pool.starmap(
            run_adapt_vqe,
            [
                (i, max_iter, tol, abs_tol, strategy, popsize, H, num_qubits, shots, num_steps, phi, num_grad_checks, operator_pool, basis_state)
    ...
    energies = [res["min_energy"] for res in vqe_results]
