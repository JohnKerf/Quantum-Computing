...
def cost_function(paulis, coeffs, num_qubits, dev):
    ...
    def energy(params):
        ...
        @qml.qnode(dev, interface="autograd")#, diff_method="parameter-shift", cache=False)
        def circuit(params):
...
if __name__ == "__main__":
    ...
    shots_list = [None] #No bounds for None
    ...
    for shots in shots_list:
        for cutoff in cutoffs:
            ...
            base_path = os.path.join("/users/johnkerf/fastscratch/Data/PennyLane/L-BFGS-B/PauliDecomp/VQE/FilesNP-RA-ParamShift", str(shots), potential)
