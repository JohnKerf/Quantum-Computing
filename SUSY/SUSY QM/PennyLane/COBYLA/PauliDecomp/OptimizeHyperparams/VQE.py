...
def run_vqe(i, max_iter, tol, H_decomp, num_qubits, shots, num_params, device, log_dir):
...
if __name__ == "__main__":
    ...
    for shots in shotslist:
        for cutoff in cutoffs:
            ...
            base_path = os.path.join(repo_path, r"SUSY\SUSY QM\PennyLane\COBYLA\PauliDecomp\OptimizeHyperparams\Bounds\With")
            ...
            with Pool(processes=10) as pool:
                vqe_results = pool.starmap(
                    run_vqe,
                    [
                        (i, max_iter, tol, H_decomp, num_qubits, shots, num_params, device, log_path)
