...
os.makedirs(r"C:\Users\Johnk\OneDrive\Desktop\PhD 2024\Quantum Computing Code\Quantum-Computing\Qiskit\SUSY VQE\Minimizer\Files\QHO\\{}".format(str(starttime)))
...
for cut_off in cut_offs_list:
    ...
    path = r"C:\Users\Johnk\OneDrive\Desktop\PhD 2024\Quantum Computing Code\Quantum-Computing\Qiskit\SUSY VQE\Minimizer\Files\QHO\\{}\QHO_{}.json".format(str(starttime), cut_off)
...
for n in cut_offs_list:
    file_path = base_path.format(str(starttime),n)
...
print("Saving plots")
plt.tight_layout()
plt.savefig(r"C:\Users\Johnk\OneDrive\Desktop\PhD 2024\Quantum Computing Code\Quantum-Computing\Qiskit\SUSY VQE\Minimizer\Files\QHO\\{}\results.png".format(str(starttime)))
